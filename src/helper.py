...
def substring_in_string_percentage(s1, s2):
    ...
    proportion_search_terms_matches = substring_matches / len(strings_list)
    proportion_substring_in_s2 = substring_matches / len(s2.split())

    return (proportion_search_terms_matches) * 0.5 + (proportion_substring_in_s2) * 0.5
...
if __name__ == '__main__':
    s1 = "ultimate gervish"
    s2 = "Ultimate Combined Magic Crystal - Gervish"
    print(substring_in_string_percentage(s1, s2.lower()))
